...
@section('content')
  ...
  <div class="row">
    <div class="col-md-6">
        <label for="nombre" class="form-label">Doocente</label>
    ...
    <div class="row">
    <div class="col-md-4">
        <label for="descripcion" class="form-label">Grupo</label>
...
<div class="row">
    <div class="col-md-12">
        <a href="{{ route('docentes_grupos.index') }}" class="btn btn-secondary">Retonar</a>
    </div>
</div>
</br>

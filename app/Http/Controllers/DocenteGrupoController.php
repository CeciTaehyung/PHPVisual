...
class DocenteGrupoController extends Controller
{
    ...
    public function index()
    {
        ...
        $docenteGrupo = $query->with('docente','grupo')
        ->orderBy('id' , 'desc')
        ->simplePaginate(10);
        $docenteGrupo = $query->orderBy('id', 'desc')->simplePaginate(10);
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('docentes_grupos.index')->woth('success' , 'Docente grupo creado correctamente');
    }
    ...
    public function update( Request $request, $id )
    {
        ...
        return redirect()->route('docentes_grupos.index')->with('success' , 'Docente grupo actualizado');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('docentes_grupos.index')->with('success' , 'Doocnte grupo eliminado correctamente');
    }
}
